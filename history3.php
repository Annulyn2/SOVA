    ...
    <div class="container mt-4">
        <div class="card">
            ...
            <?php
                    ...
                    $history ="SELECT COUNT(*) AS `count` 
                        FROM scan_history 
                        WHERE `placeID` = '$user_id'
                        JOIN swab_history ON scan_history.`userID`= swab_history.`user_id` 
                        WHERE `status`='positive' ORDER BY `date` ASC";
                    ...
                    <?php } else { ?>
                        <p class="text-center lead text-gray-800 my-5">Safe!</p>
                    <?php } ?>
                <div>
