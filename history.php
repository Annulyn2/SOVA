    ...
    <div class="container mt-4">
        <div class="card">
            ...
            <?php
                    ...
                    $history = "SELECT * FROM `scan_history` JOIN `place` ON `scan_history`.`placeID`=`place`.`company_id` WHERE `userID` = '$user_id' ORDER BY `date` ASC";
                            ...
                            while($items = mysqli_fetch_assoc($query)){ 
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $items['c_address']; ?> </td>
                    ...
                    <?php } else { ?>
                        <p class="text-center lead text-gray-800 my-5">You haven't gone out yet!</p>
                    <?php } ?>
                <div>
